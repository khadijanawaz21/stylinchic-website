      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <AnimatedReveal className="mx-auto max-w-2xl">
          <div className="text-center">
            ...
            <h3 className="font-heading text-[26px] font-medium tracking-[-0.02em] text-espresso">
              Shabana
            </h3>
            <p className="mt-1 text-[15px] text-espresso/55">Lead Stylist</p>

            <p className="mx-auto mt-4 max-w-md text-[15px] text-espresso/55 leading-relaxed">
            ...
            <motion.a
              ...
              className="mt-6 inline-flex items-center gap-2 text-[14px] font-medium text-accent hover:text-accent-hover transition-colors"
