            ...
            {submitted ? (
              ...
              >
                ...
                <button
                  ...
                  className="mt-6 text-sm font-medium text-accent hover:text-accent-rose transition-colors cursor-pointer"
                >
              ...
              >
                ...
                <motion.button
                  type="submit"
                  className="w-full rounded-xl bg-accent py-3.5 font-medium text-cream transition-colors hover:bg-accent-rose disabled:opacity-50 cursor-pointer"
